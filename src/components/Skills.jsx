...
const Skills = () => {
  ...
  const getIcon = (iconName) => {
    ...
    if (iconName && iconName.startsWith("/")) {
      return (
        <img src={iconName} alt={iconName} className="w-6 h-6 object-contain" />
      );
    }
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            A combination of technical expertise and essential soft skills that
        ...
        <div className="grid grid-cols-1 gap-12">
            ...
            <CardContent className="overflow-hidden">
              <div className="marquee">
                <div className="marquee-content">
                  {[...skills.hardSkills, ...skills.hardSkills].map(
                    (skill, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg min-w-max"
                      >
          ...
          <Card className="p-6 border-2 border-slate-200 hover:border-blue-200 transition-all duration-300 hover:shadow-lg">
            ...
            <CardContent className="overflow-hidden">
              <div className="marquee">
                <div className="marquee-content">
                  {[...skills.softSkills, ...skills.softSkills].map(
                    (skill, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-3 p-4 bg-slate-50 rounded-lg min-w-max 
